...
let aboutData = {
    "title": "About Me",
    "description": "I’m an Engineering Manager at Telus Digital AI Data Solutions with deep roots in backend engineering and a strong product mindset. I specialize in building scalable systems, optimizing engineering workflows, and leading high-performing teams. \n From AI-driven resume screening tools to GitHub automation bots, I enjoy building end-to-end products that are fast, functional, and fun to use. I’m also passionate about leveraging LLMs, exploring anime-inspired branding, and launching ideas that stick.",
    "personalInfo": {
        "name": "Karan Dev",
